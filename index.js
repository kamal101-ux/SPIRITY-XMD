...
const port = process.env.PORT || 9090;
  ...
  let up = `╭─〔 *👻 𝐒𝐏𝐈𝐑𝐈𝐓𝐘-𝐗𝐌𝐃 BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT 𝐒𝐏𝐈𝐑𝐈𝐓𝐘-𝐗𝐌𝐃* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🍷 Thank You for Choosing 𝐒𝐏𝐈𝐑𝐈𝐓𝐘-𝐗𝐌𝐃!* 
...
╰─🚀 *Powered by 𝙳̷𝚊̷𝚛̷𝚔̷-𝙳̷𝙴̷𝚟̷🩸*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/zmhz85.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ('22603582906', '22603582906', '22603582906');
